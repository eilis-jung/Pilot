                                        ...
                                        void*                       ui_state)
{
    ...
    m_main_camera_pass.draw(
        m_color_grading_pass, m_brightness_filter_pass, m_gaussian_blur_x_pass, m_gaussian_blur_y_pass, m_copy_pass, m_tone_mapping_pass, m_ui_pass, m_combine_ui_pass, current_swapchain_image_index, ui_state);
