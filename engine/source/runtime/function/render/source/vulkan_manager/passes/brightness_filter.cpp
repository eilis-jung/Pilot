...
namespace Pilot
{
    void PBrightnessFilterPass::initialize(VkRenderPass render_pass, VkImageView input_attachment)
    {
    ...
    void PBrightnessFilterPass::setupDescriptorSetLayout()
    {
    ...
    void PBrightnessFilterPass::setupPipelines()
    {
        ...
        VkShaderModule frag_shader_module =
            PVulkanUtil::createShaderModule(m_p_vulkan_context->_device, BRIGHTNESS_FILTER_FRAG);
        ...
        pipelineInfo.subpass             = _main_camera_subpass_brightness_filter;
    ...
    void PBrightnessFilterPass::setupDescriptorSet()
    {
    ...
    void PBrightnessFilterPass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
    ...
    void PBrightnessFilterPass::draw()
    {
        
        if (m_render_config._enable_debug_untils_label)
        {
            VkDebugUtilsLabelEXT label_info = {
                VK_STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT, NULL, "Bloom Filter", {1.0f, 1.0f, 1.0f, 1.0f}};
