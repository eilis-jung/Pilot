...
namespace Pilot
{
    void PBloomFilterPass::initialize(VkRenderPass render_pass, VkImageView input_attachment)
    {
    ...
    void PBloomFilterPass::setupPipelines()
    {
    ...
    void PBloomFilterPass::setupDescriptorSet()
    {
