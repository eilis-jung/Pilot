...
bool Pilot::PVulkanManager::initializeRenderPass()
{
    ...
    m_gaussian_blur_x_pass.initialize(m_main_camera_pass.getRenderPass(), m_main_camera_pass.getFramebufferImageViews()[_main_camera_pass_backup_buffer_odd], m_main_camera_pass.getFramebufferImageViews()[_main_camera_pass_brightness_buffer], m_mesh_perframe_storage_buffer_object);

    m_gaussian_blur_y_pass.initialize(m_main_camera_pass.getRenderPass(), m_main_camera_pass.getFramebufferImageViews()[_main_camera_pass_backup_buffer_even], m_mesh_perframe_storage_buffer_object);
